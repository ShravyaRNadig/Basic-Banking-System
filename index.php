...
<body>
    ...
    <class class="welcome">
        <h2>
             <strong>Welcoming you in the most trusted TSF Bank !</strong> 
        </h2>
    </class>
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div class="col-auto d-none d-lg-block"><br>
                        <img class="bd-placeholder-img" width="350" height="250" src="background/c1.jfif" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    ...
                    <div class="col-auto d-none d-lg-block"> <br>
                        <img class="bd-placeholder-img" width="300" height="250" src="background/c2.jfif" alt="" align="center">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="foot">
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                © 2021 Copyright - Made with 🧡 by Shravya Nadig :
